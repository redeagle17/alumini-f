      ...
      <div className="grid gap-10 row-gap-8 lg:grid-cols-3">
        <div>
          ...
          <p className="text-gray-700">
            Number of Alumni that are working professionals in leading
            industries.
          </p>
        </div>
        <div>
          ...
          <p className="text-gray-700">Have already connected with alumni's.</p>
        </div>
        <div>
          <div className="flex">
            <h6 className="mr-2 text-4xl font-bold md:text-5xl text-blue-900">
          ...
          <p className="text-gray-700">Guidance given by Alumni to students.</p>
        </div>
      </div>
    </div>
  );
